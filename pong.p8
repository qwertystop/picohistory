...
function mobactor:reset(dir)
	...
	self.pos = self.pos0
	self.vel = (heading(rnd(1))
		+ vec2(weight, 0)):normalize()
end
...
function playeractor:update()
	if btn(0, self.pnum) then
		self.vel.x -= self.accel
	elseif btn(1, self.pnum) then
		self.vel.x += self.accel
	else
		self.vel.x = 0
	end
...
function game:initialize()
	...
	local function paddlecol(paddle, other, force)
		local sc = paddle:coll():center()
		local oc = other:coll():center()
		local rel_y = (sc - oc).y
...
__gfx__

__gff__
...
__map__

